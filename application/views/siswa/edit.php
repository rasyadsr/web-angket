                        ...
                        <div class="card">
                            <div class="card-body">
                                <?php foreach($students as $student) : ?>
                                    <form class="form-horizontal form-material mx-2" action="<?= base_url('Siswa/update/'.$student->id) ?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <?php endforeach; ?>
                                                <input type="file" value="<?= $student->nama ?>"
